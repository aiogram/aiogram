...
This file is autogenerated from Docs of Telegram Bot API at 2019-06-30 20:10:58 UTC
"""
import typing
...
class Update(pydantic.BaseModel):
    ...
    edited_message: typing.Optional[types.Message] = None
    """New version of a message that is known to the bot and was edited"""

    channel_post: typing.Optional[types.Message] = None
    """New incoming channel post of any kind — text, photo, sticker, etc."""

    edited_channel_post: typing.Optional[types.Message] = None
    """New version of a channel post that is known to the bot and was edited"""

    inline_query: typing.Optional[types.InlineQuery] = None
    """New incoming inline query"""

    chosen_inline_result: typing.Optional[types.ChosenInlineResult] = None
    """The result of an inline query that was chosen by a user and sent to their chat partner. Please see our documentation on the feedback collecting for details on how to enable these updates for your bot."""

    callback_query: typing.Optional[types.CallbackQuery] = None
    """New incoming callback query"""

    shipping_query: typing.Optional[types.ShippingQuery] = None
    """New incoming shipping query. Only for invoices with flexible price"""

    pre_checkout_query: typing.Optional[types.PreCheckoutQuery] = None
    """New incoming pre-checkout query. Contains full information about checkout"""

    poll: typing.Optional[types.Poll] = None
...
class Message(pydantic.BaseModel):
    ...
    reply_to_message: typing.Optional[types.Message] = None
    ...
    sticker: typing.Optional[types.Sticker] = None
    """Message is a sticker, information about the sticker"""

    video: typing.Optional[types.Video] = None
    """Message is a video, information about the video"""

    voice: typing.Optional[types.Voice] = None
    """Message is a voice message, information about the file"""

    video_note: typing.Optional[types.VideoNote] = None
    """Message is a video note, information about the video message"""

    caption: typing.Optional[str] = None
    """Caption for the animation, audio, document, photo, video or voice, 0-1024 characters"""

    contact: typing.Optional[types.Contact] = None
    """Message is a shared contact, information about the contact"""

    location: typing.Optional[types.Location] = None
    """Message is a shared location, information about the location"""

    venue: typing.Optional[types.Venue] = None
    """Message is a venue, information about the venue"""

    poll: typing.Optional[types.Poll] = None
    """Message is a native poll, information about the poll"""

    new_chat_members: typing.Optional[typing.List[types.User]] = None
    """New members that were added to the group or supergroup and information about them (the bot itself may be one of these members)"""

    left_chat_member: typing.Optional[types.User] = None
    ...
    invoice: typing.Optional[types.Invoice] = None
    """Message is an invoice for a payment, information about the invoice."""

    successful_payment: typing.Optional[types.SuccessfulPayment] = None
    """Message is a service message about a successful payment, information about the payment."""

    connected_website: typing.Optional[str] = None
    """The domain name of the website on which the user has logged in."""

    passport_data: typing.Optional[types.PassportData] = None
...
class InlineKeyboardButton(pydantic.BaseModel):
    ...
    callback_game: typing.Optional[types.CallbackGame] = None
...
class InlineQueryResultPhoto(pydantic.BaseModel):
    ...
    input_message_content: typing.Optional[types.InputMessageContent] = None
...
class OrderInfo(pydantic.BaseModel):
    ...
    shipping_address: typing.Optional[types.ShippingAddress] = None
...
class SuccessfulPayment(pydantic.BaseModel):
    ...
    order_info: typing.Optional[types.OrderInfo] = None
...
class Game(pydantic.BaseModel):
    ...
    text_entities: typing.Optional[typing.List[types.MessageEntity]] = None
