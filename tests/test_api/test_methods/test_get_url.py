...
class TestGetMessageUrl:
    def test_method(self, bot: MockedBot):
        ...
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_pm,
        )
        ...
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_group,
        )
        assert fake_message.get_url() is None
        ...
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_supergroup_no_username,
        )
        ...
        fake_chat_supergroup_username = Chat(id=-1001234567890, username="username", type="supergroup")
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_supergroup_username,
        )
        assert fake_message.chat.shifted_id == 1234567890
        assert fake_message.get_url() == f"https://t.me/username/{fake_message_id}"
        assert fake_message.get_url(force_private=True) == f"https://t.me/c/1234567890/{fake_message_id}"
        ...
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_channel_no_username,
        )
        assert fake_message.chat.shifted_id == 1234567890
        assert fake_message.get_url() == f"https://t.me/c/1234567890/{fake_message_id}"
        ...
        fake_message = Message(
            message_id=fake_message_id, date=datetime.datetime.now(),
            text="test", chat=fake_chat_channel_username,
        )
        assert fake_message.chat.shifted_id == 1234567890
        assert fake_message.get_url() == f"https://t.me/username/{fake_message_id}"
        assert fake_message.get_url(force_private=True) == f"https://t.me/c/1234567890/{fake_message_id}"
